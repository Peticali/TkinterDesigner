...
class app(): #NOT DELETE ANY COMMENTS GENERATED BY THE PROGRAM."""
    ...
    def importProject(self):
        ...
        while countImportar <= countWidgets :
            ...
            self.objs[widgetName].place(x=placex,y=placey)
    ...
    def __init__(self):
        ...
        createButton = Button(self.janela,styleButtons,text='botao',command=lambda:[app.createComponent(self,value='botao')])
