...
class app(): #NOT DELETE ANY COMMENTS GENERATED BY THE PROGRAM."""
        ...
        while count < size: #pega todas as propriedades de todos objetos na tela
            ...
            for property in self.objs[widget].keys():
                ...
                if property == "command":
                    ...
                    if globals()[type]()[property] != value:
                        string = string + property + '=' +  "'" + str(value) + "'" + ','
    ...
    def importProject(self):
        ...
        while countImportar <= countWidgets :
            ...
            self.objs[widgetName] = globals()[tipo](self.frameDesigner,propertyDict)
    ...
    def Copy(self,e): #ainda precisa arrumar
        ...
        self.objs[newObjName] = globals()[newObjType](self.frameDesigner)
    ...
    def __init__(self):
        ...
        createButton = Button(createButtonsFrame,styleButtons,text='Button',command=lambda:[app.createComponent(self,value='botao')])
