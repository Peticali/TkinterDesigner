...
class app(): #NOT DELETE ANY COMMENTS GENERATED BY THE PROGRAM."""
    ...
    def resizeWindow(self,event):
        ...
        self.exportButton.place(x=listboxPosx-50)
        self.deleteButton.place(x=listboxPosx-50)
        self.RenameButton.place(x=listboxPosx-50)
    ...
    def Copy(self,e): #ainda precisa arrumar
        ...
        newObj = self.objs[self.objectSelected].winfo_class()

        print(newObj)

        #print(self.objs)

        #self.objs[newObjName] = newObj
        #self.objs[newObjName].place(x=centerx,y=centery)
    ...
    def RenameWidget(self):
        ...
        selection = self.listObjectsGUI.curselection()[0]
        self.objs[newName] = self.objs.pop(self.objectSelected)
        self.listObjectsGUI.delete(selection)
        self.listObjectsGUI.insert(selection,newName)
    ...
    def renameWidgetWindow(self):
        ...
        labelRename = Label(self.renameWindow, text="New Name for " + self.objectSelected + ":",bg="#242526",fg="white")
        labelRename.pack(fill='x',side="top")
    ...
    def __init__(self):
        ...
        self.exportButton = Button(self.janela,styleButtons,text="export",bg="#3BB143",command=self.getObjectsExport)
        self.exportButton.place(x=640,y=35)

        self.deleteButton = Button(self.janela,styleButtons,text="delete",bg="#FF0000",command=self.deleteComponent)
        self.deleteButton.place(x=640,y=68)

        self.RenameButton = Button(self.janela,styleButtons,text="rename",bg="#FF0000",command=self.renameWidgetWindow)
        self.RenameButton.place(x=640,y=100)
