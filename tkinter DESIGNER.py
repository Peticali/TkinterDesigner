...
class app():
    ...
    def attachProperties(self): #TODO: fix old code
    ...
    def propertyDetach(self): #TODO: fix old code
    ...
    def getObjectsExport(self):#TODO: fix old code
        countScript = 0
        ...
        for countScript in range(scriptCount): #Onclick Functions
            widgetName = list(self.objScripts.keys())[countScript]
            widgetScript = self.objScripts[widgetName]
            widgetScript = '        '.join(('\n'+widgetScript.lstrip()).splitlines(True))#add tab for the final.py and \n
            StrFunction = tab + 'def ' + widgetName + '(self):\n'
            StrFunction = StrFunction  + widgetScript

            code = code + '\n' + StrFunction + "\n" + "\t\t#endFunction\n"

        code = code + "\n%sdef __init__(self):\n%sself.root = Tk() \n" % (tab,doubletab)
        code = code + "\n" + doubletab + "self.root.title('" + self.windowTitle + "')" 
        code = code + "\n        self.root.config(bg='" + self.windowBG + "')\n        "
        ...
        size = len(lista)
        for count in range(size):#pega todas as propriedades de todos objetos na tela
            widget = lista[count]
            ...
            string = doubletab + 'self.' + widget + " = " + string[:-1] + ')\n'  
            string = string + doubletab + "self.%s.place(x=%i,y=%i,height=%i,width=%i)" % (widget,x,y,height,width)
            code = code + "\n" + string
    ...
    def importProject(self):#TODO: fix old code
        countWidgets = 0
        countImportar = 1
        countWidgetLine = 1
        countPlaceLine = 2
    ...
    def scriptBoxGetPropertyWindow(self):#TODO: fix old code
    ...
    def moveObj(self,event):#TODO: fix old code
        self.soltar = 0
        try:
    ...
    def resizeWindow(self,event):#TODO: fix old code
    ...
    def RenameWidget(self):
        ...
        try:
            x = self.objs[newName] #NOT REMOVE
